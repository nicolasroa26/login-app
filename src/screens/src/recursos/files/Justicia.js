...
export default class Justicia extends Component {
  state = {
    todoList: [{
      key: "1",
      proyecto: "I. Proyectos de construcción, adecuación, mantenimiento o dotación en el marco del Programa Nacional de Casas de Justicia y Convivencia Ciudadana. ",
      requisitos: "- Certificado expedido por la Dirección de Métodos Alternativos de Solución de Conflictos del Ministerio de Justicia y del Derecho en el que conste el cumplimiento de los lineamientos, procedimientos y requisitos establecidos por esta cartera, de conformidad con lo previsto en los Decretos 2897 de 2011 y 1427 de 2017.",
    }],
