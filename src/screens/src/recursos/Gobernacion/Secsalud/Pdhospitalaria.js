...
export default class ICCU extends Component {
  state = {
    todoList: [
      {
      key: "1",
      proyecto: "REQUISITOS PROYECTOS DOTACIÓN HOSPITALARIA	",
      requisitos: "1. Oficio presentación proyecto (Para Municipios) \n2. MGA en PDF \n3. Presupuesto del proyecto \n4. Documento técnico / Diagnóstico (Formato E-DAG-FR-076) \n5. Portafolio de servicios de la ESE  \n6. Cotizaciones recientes (mínimo dos) \n7. Cámara de comercio de cada uno de los proveedor \n8. Certificación de autorización para distribución \n9. Certificado de disponibilidad presupuestal \n10. Carta de compromiso operación y mantenimiento \n11. Carta de compromiso firmada por el Alcalde \n12. Certificación de existencia de la infraestructura ",
    }],
