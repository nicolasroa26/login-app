...
export default class ICCU extends Component {
  state = {
    todoList: [{
        ...
        tproyectos: "* Cooperación Educativa y Universitaria\n* Acción Cultural\n* Acción Audiovisual",
        dirigido: "Funcionarios públicos, estudiantes del IAED",
        mecanismo: "A través de la Embajada",
        como: "Tomar contacto directo con la Embajada.Convocatoria para la Escuela Nacional de Administración, para la formación de altos funcionarios, abierta cada  año en enero",
        requisitos:"N/A",
        montos: "N/A",
        plazos: "Mes de enero",
        medios: "http://www.ambafrance-co.org/-Espanol-"    
