...
export default class CStecno extends Component {
  state = {
        educacion:[
            {
                key: "1",
                nombre:"PREINVERSIÓN: ESTUDIOS, DISEÑOS, CONSULTORIAS, ASESORIAS E INTERVENTORIAS",
                EDUCACION:"",
                ALIMENTACION:"",
                INVERSION:"",
                DESTINACION:"",
                ...
                key: "2",
                nombre:"CONSTRUCCIÓN AMPLIACIÓN Y ADECUACIÓN DE INFRAESTRUCTURA EDUCATIVA",
                EDUCACION:"",
                ALIMENTACION:"",
                INVERSION:"",
                DESTINACION:"",
                ...
                key: "3",
                nombre:"MANTENIMIENTO DE INFRAESTRUCTURA EDUCATIVA ",
                EDUCACION:"",
                ALIMENTACION:"",
                INVERSION:"",
                DESTINACION:"",
                ...
                key: "4",
                nombre:"DOTACIÓN INSTITUCIONAL DE MATERIAL Y MEDIOS PEDAGÓGICOS PARA EL APRENDIZAJE ",
                EDUCACION:"",
                ALIMENTACION:"",
                INVERSION:"",
                DESTINACION:"",
                ...
                key: "5",
                nombre:"PAGO DE SERVICIOS PÚBLICOS DE LAS INSTITUCIONES EDUCATIVAS ",
                EDUCACION:"",
                ALIMENTACION:"",
                INVERSION:"",
                DESTINACION:"",
    ...
    handlechange(){
      console.log(this.state.EDUCACION)
                      ...
                      <ScrollView style={{overflowY: "scroll", height: 650, width: "auto"}}>
                        ...
                        <ScrollView>
                            ...
                            <View>
                                ...
                                maxLength={10} 
                                style={styles.cuadrostext}
                                onChangeText={text => this.setState({ALIMENTACION:text})}/>
                            </View>
                            <View>
                                <Text style={{ color: '#9CAAC4', fontSize: 16, fontWeight: '600' }}>
                                ...
                                maxLength={10} 
                                style={styles.cuadrostext}
                                onChangeText={text => this.setState({INVERSION:text})}/>
                            </View>
                            <View>
                                <Text style={{ color: '#9CAAC4', fontSize: 16, fontWeight: '600' }}>
