...
export default class Iinfraestrucatura extends Component {
  state = {
    todoList: [{
      key: "1",
      metab: "Reducir el tiempo promedio de desplazamiento entre los municipios de sabana centro, sabana de occidente, Soacha y Bogotá.",
      indicadorb: "Minutos promedio de desplazamiento entre  los municipios y Bogotá",
      resultadob: "45",
    }],
    metalist: [{
      key: "2",
      metap: "Intervenir 10 conexiones viales de la ciudad -región.",
      indicadorp:"Número de conexiones intervenidas",
      resultadop:"10"
    }],
