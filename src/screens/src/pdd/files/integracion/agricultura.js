...
export default class Iagricultura extends Component {
  state = {
    todoList: [{
      key: "1",
    ...
    metalist: [{
      key: "2",
      metap: "Beneficiar a 3.000 familias mediante la estrategia Zodas para el abastecimiento agroalimentario de Cundinamarca y la región.",
      indicadorp:"Familias beneficiadas con la estrategia",
      resultadop:"3,000"
    }],
