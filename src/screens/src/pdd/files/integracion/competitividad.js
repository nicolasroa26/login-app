...
export default class Icompetitividad extends Component {
  state = {
    todoList: [{
      key: "1",
    ...
    metalist: [{
      key: "2",
      metap: "Apoyar la adecuación y funcionamiento de 4 plantas de beneficios animal.",
      indicadorp:"Número de plantas de beneficios animal adecuadas",
      resultadop:"4"
    },{
      key: "3",
      metap: "Desarrollar una planta de abonos al servicio de la región.",
      indicadorp:"Planta de abonos regional desarrollada",
      resultadop:"1"
    }],
