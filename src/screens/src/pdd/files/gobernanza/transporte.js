...
export default class GTransporte extends Component {
  state = {
    todoList: [{
      key: "1",
    ...
    metalist: [{
      key: "2",
      metap: "Implementar la estrategia Me muevo por Cundinamarca para modernizar los procesos de trámites y servicios al ciudadano de la Secretaría de Movilidad.",
