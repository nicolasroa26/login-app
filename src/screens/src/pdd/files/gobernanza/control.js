...
export default class GControl extends Component {
  state = {
    todoList: [{
      key: "1",
    ...
    metalist: [{
      key: "2",
      metap: "Implementar un modelo de operación integral  para la evaluación del Sistema de Control Interno hacia las normas internacionales de auditoría.",
      indicadorp:"Modelo de Operación Integral  para la Evaluación del Sistema de Control Interno del Departamento Implementado",
      resultadop:"1"
    }],
    thirdlist:[{
      key: "3",
    ...
    fourthlist: [{
      key: "4",
      metap: "Implementar un plan de transparencia, integridad, evaluación y cultura de control.",
      indicadorp:"Plan de integridad, control y evaluación territorial  implementado",
      resultadop:"1"
    }],
