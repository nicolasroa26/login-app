...
export default class GEducacion extends Component {
  state = {
    todoList: [{
      key: "1",
    ...
    metalist: [{
      key: "2",
      metap: "Mantener certificados  los 4 procesos correspondientes a la Secretaría de Educación  en la norma ISO 21001:2018.",
      indicadorp:"Procesos certificados",
      resultadop:"4"
    }],
