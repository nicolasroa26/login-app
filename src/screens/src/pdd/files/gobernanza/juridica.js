...
export default class GJuridica extends Component {
  state = {
    todoList: [{
      key: "1",
      metab: "Reducir la actividad judicial en contra del departamento.",
      indicadorb: "Procesos judiciales contra del departamento",
      resultadob: "834",
    }],
    metalist: [{
      key: "2",
      metap: "Ejecutar un plan integral de apoyo jurídico a los funcionarios del nivel central, descentralizado y a los municipios.",
      indicadorp:"Plan de apoyo jurídico ejecutado",
      resultadop:"1"
    }],
