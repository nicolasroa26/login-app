...
export default class GHacienda extends Component {
  state = {
    todoList: [{
      key: "1",
      metab: "Aumentar el índice de desempeño fiscal del departamento.",
      indicadorb: "Índice de desempeño fiscal",
      resultadob: "78.70%",
    }],
    metalist: [{
      key: "2",
      metap: "Implementar cuatro planes de fiscalización tributaria y operativa de los tributos departamentales.",
      indicadorp:"Plan implementado",
      resultadop:"4"
    },{
      key: "3",
      metap: "Potencializar el proceso de recaudo para 5 tributos departamentales con herramientas tecnológicas. ",
      indicadorp:"Tributo potencializado",
      resultadop:"5"
    },{
      key: "4",
      metap: "Potencializar 5 procesos  transversales a la gestión financiera.",
      indicadorp:"Proceso potencializado",
      resultadop:"5"
    }],
