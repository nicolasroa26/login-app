...
export default class Infraestructura extends Component {
  state = {
    todoList: [{
      key: "1",
    ...
    metalist: [{
      key: "2",
      metap: "Ejecutar el 100% de la segunda fase de la reubicación del municipio de Utica (Obras complementarias)",
      indicadorp:"Segunda fase implementada",
      resultadop:"1"
    },{
      key: "3",
      metap: "Intervenir 85.000 m2 de espacio público.",
      indicadorp:"Número de m2  de espacio público intervenidos",
      resultadop:"85,000"
    }],
