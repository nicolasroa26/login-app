...
export default class Transporte extends Component {
  state = {
    STblist: [{
      key: "1",
      metab: "Disminuir los siniestros de transito con resultados fatales en Cundinamarca",
      indicadorb: "Siniestros de transito con resultados fatales en Cundinamarca",
      resultadob: "490"
    }],
    STplist: [{
      key: "2",
      metap: "Implementar la estrategia  (Por la Vía de la Vida) para la  intervención, prevención y monitoreo de la seguridad vial en Cundinamarca",
