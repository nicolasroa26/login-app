...
export default class Corporacion extends Component {
  state = {
    todoList: [{
      key: "1",
    ...
    metalist: [{
      key: "2",
      metap: "Atender a 4000 afiliados y beneficiarios con actividades de bienestar que ofrece la Corporación Social.",
      indicadorp:"Beneficiados con programas de bienestar que ofrece la Corporación Social",
      resultadop:"4,000"
    }],
