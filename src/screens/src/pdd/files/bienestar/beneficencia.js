...
export default class Beneficencia extends Component {
  state = {
    todoList: [{
      key: "1",
      metab: "Implementar la política pública de salud mental.",
      indicadorb: "Ejecución del plan de implementación de la política publica de salud mental",
      resultadob: "45.00%",
    }],
    metalist: [{
      key: "2",
      metap: "Brindar protección social integral a 790 personas adultas mayores cada año en los centros de protección de la Beneficencia de Cundinamarca.",
      indicadorp:"Número de personas adultas mayores protegidas",
      resultadop:"790"
    },{
      key: "3",
      metap: "Atender a 500 personas mayores de 18 años consumidoras de sustancias psicoactivas.",
      indicadorp:"Número de personas consumidoras de sustancias psicoactivas atendidas",
      resultadop:"500"
    }],
    thirdlist:[{
      key: "4",
    ...
    fourthlist: [{
      key: "5",
      metap: "Brindar protección social integral a 1.500 personas mayores de 18 años con discapacidad mental en los centros de protección.",
      indicadorp:"Número de personas con discapacidad mental protegidas",
      resultadop:"1,500"
    }],
