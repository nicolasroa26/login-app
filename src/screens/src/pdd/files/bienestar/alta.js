...
export default class Alta extends Component {
  state = {
    ...
    metalist: [{
      key: "2",
      metap: "Implementar el observatorio de felicidad y bienestar de Cundinamarca.",
      indicadorp:"Observatorio implementado",
      resultadop:"1"
    },{
      key: "3",
      metap: "Implementar la política pública de felicidad y bienestar en la primera fase",
      indicadorp:"Fases de la política pública de felicidad y bienestar implementadas",
      resultadop:"1"
    },{
      key: "4",
      metap: "Implementar  la Escuela Móvil de Atención en  Bienestar y Felicidad del departamento",
      indicadorp:"Escuela móvil de atención en bienestar y felicidad implementada",
      resultadop:"1"
    }],
