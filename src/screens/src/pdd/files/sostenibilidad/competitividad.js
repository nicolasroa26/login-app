...
export default class SCompetitividad extends Component {
  state = {
    todoList: [{
      key: "1",
      metab: "Reducir las emisiones de gases de efecto invernadero en el Departamento.",
      indicadorb: "Millones de toneladas de CO2eq",
      resultadob: "2,3 Millones de toneladas de CO2eq",
    }],
    metalist: [{
      key: "2",
      metap: "Intervenir en 100 MIPYMES o esquemas asociativos estrategias de mitigación en procesos productivos, negocios verdes y energías limpias, renovables y alternativas.",
      indicadorp:"MIPYMES o esquemas asociativos intervenidos ",
      resultadop:"100"
    }],
            ...
            <View style = {{ flex: 1, paddingTop: Constants.statusBarHeight, backgroundColor: "#3280e4" }}>
              <ScrollView style = {styles.subcontainer}>
                <View style = {{ marginBottom:30 }}>
                  ...
                  Alternativas verdes para el crecimiento
				  </Text>
          <View style={styles.sepeerator1}/>
                  <Text style = {{color: '#9CAAC4', marginLeft:10, fontSize:16, fontWeight: '600'}}>
                    Meta de bienestar:
