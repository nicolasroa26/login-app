...
export default class SMinas extends Component {
  state = {
    todoList: [{
      key: "1",
    ...
    metalist: [{
      key: "2",
      metap: "Implementar estrategias  de energías renovables  en 50  entornos en el departamento.",
      indicadorp:"Numero de entornos con estrategias de energías renovables",
      resultadop:"109\n50 Nuevos"
    }],
