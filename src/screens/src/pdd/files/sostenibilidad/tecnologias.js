...
export default class STecnologias extends Component {
  state = {
    todoList: [{
      key: "1",
      metab: "Reducir las emisiones de gases de efecto invernadero.",
      indicadorb: "Kton CO2 eq de emisiones de efecto invernadero",
      resultadob: "10,957",
    }],
    metalist: [{
      key: "2",
      metap: "Recolectar y llevar a destino final 120 toneladas de residuos de aparatos eléctricos y electrónicos.",
      indicadorp:"Toneladas de residuos electrónicos recolectados",
      resultadop:"270\n120 Nuevas"
    }],
            ...
            <View style = {{ flex: 1, paddingTop: Constants.statusBarHeight, backgroundColor: "#3280e4" }}>
              <ScrollView style = {styles.subcontainer}>
                <View style = {{ marginBottom:30 }}>
                  ...
                  Cundinamarca resiliente al cambio climático 
				  </Text>
          <View style={styles.sepeerator1}/>
                  <Text style = {{color: '#9CAAC4', marginLeft:10, fontSize:16, fontWeight: '600'}}>
                    Meta de bienestar:
