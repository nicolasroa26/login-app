...
export default class SPublica extends Component {
  state = {
    todoList: [{
      key: "1",
      metab: "Aumentar  la  cobertura en educación ambiental comunitaria e institucional.",
      indicadorb: "Personas con cobertura en educación ambiental",
      resultadob: "44,000",
    }],
    metalist: [{
      key: "2",
      metap: "Implementar el 100% del sistema de gestión ambiental bajo la NTC ISO 14001: 2015 en la gobernación.",
      indicadorp:"Avance en la implementación del Sistema implementado",
      resultadop:"100%"
    }],
