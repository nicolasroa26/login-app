...
export default class Cmujer extends Component {
  state = {
    Pcblist: [{
      key: "1",
      metab: "Aumentar los proceso de emprendimiento y productividad de la mujer cundinamarquesa",
      indicadorb: "Número de procesos de emprendimiento realizados",
      resultadob: "626",
    }],
    Pcplist: [{
      key: "2",
      metap: "Impulsar 1200 proyectos productivos de mujeres u organizaciones de mujeres, mediante le fortalecimiento tecnico,  economico y productivo.",
      indicadorp:"Mujeres con proyectos y planes productivos en desarrollo",
      resultadop:"1.200"
    }],
