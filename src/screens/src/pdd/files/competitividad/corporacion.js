...
export default class CCorporacion extends Component {
  state = {
    todoList: [{
      key: "1",
    ...
    metalist: [{
      key: "2",
      metap: "Implementar 3 estrategias para incentivar proyectos productivos de impacto social.",
      indicadorp:"Estrategias Implementadas",
      resultadop:"3"
    }],
