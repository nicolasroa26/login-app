...
export default class CreateTask extends Component {
  ...
  render() {
    const {state: {selectedDay, currentDay, visibleHeight},props: { navigation }} = this;
    return (
      <Context.Consumer>
        {value => (
              ...
              <View style={{height: visibleHeight,}}>
                <ScrollView contentContainerStyle={{ paddingBottom: 100,}}>
                  ...
                  <CalendarList style={{ width: 350, height: 350, }}
                      ...
                      pagingEnabled
                      calendarWidth={350}
                      onDayPress={day => { this.setState({ selectedDay: { [day.dateString]: { selected: true, selectedColor: '#2E66E7',  },},currentDay: day.dateString,});}}
                      monthFormat="MMMM yyyy"
                      hideArrows
                      markingType="simple"
                      theme={{selectedDayBackgroundColor: '#2E66E7', selectedDayTextColor: '#ffffff', todayTextColor: '#2E66E7', backgroundColor: '#eaeef7', calendarBackground: '#000000', textDisabledColor: '#d9dbe0',}}
